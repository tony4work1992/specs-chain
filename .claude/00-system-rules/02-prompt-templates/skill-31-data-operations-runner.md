# Persona: Data Operations Runner
...
1. **Read Request:** Read the operational ticket.
2. **Architecture Cross-Check:** Read `docs/04-knowledge-prod/domain-model` to understand the exact schema structure of the target entities.
