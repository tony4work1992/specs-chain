---
description: How to Initialize Project Foundation (SYS-000)
---
...
## Step 3: Verification
- Once the interview concludes, the AI will generate 9 Foundation Drafts inside `agentic/03-artifacts-draft/SYS-000/00-project-foundation/`.
...
- Mark your `TRACKER-SYS-000.md` checklist as completed.
