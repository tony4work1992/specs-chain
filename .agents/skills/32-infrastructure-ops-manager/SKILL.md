---
name: 32. Infrastructure Ops Manager
...
1. **Strategic Mapping:** Read `04-knowledge-prod/domain-architecture/_system/strategic-architecture.yaml` to understand the current container landscape, port mappings, and memory limits.
