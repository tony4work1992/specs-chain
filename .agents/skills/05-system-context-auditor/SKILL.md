---
name: 05. System Context Auditor
description: Trigger workflow for System Context Auditor
---
# Instruction
...
`./agentic/00-system-rules/03-system-mappings/skill-05-system-context-auditor.yaml`
