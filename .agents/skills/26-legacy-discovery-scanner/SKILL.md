...
## The Mission
Scan the physical legacy codebase (excluding `node_modules` and standard ignored paths). Look for textual and structural patterns that strongly indicate the presence of architectural layers. Group these discoveries into a unified report.
