---
name: 25. Autonomous Test Generation
...
# Skill 25: Autonomous Test Generation (TDD Coder)
...
## Pre-Flight Checks
1. Validate that the current feature's Test Suite Knowledge exists at `docs/04-knowledge-prod/test-case-suite/{feature-slug}/`.
2. Validate that `docs/05-support-assets/framework-routing.yaml` exists and contains a valid `test_routing` block.
3. Validate that you are NOT instructed to write actual business logic in this session.
